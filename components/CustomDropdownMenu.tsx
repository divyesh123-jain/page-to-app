...
const CustomDropdownMenu = (props: CustomDropdownMenuProps) => {
	...
	const buttonClasses = clsx(
		...
		buttonProps.disabled
			? "!bg-gray-300 !text-gray-600 opacity-50 cursor-not-allowed pointer-none hover:bg-transparent"
			: "",
					...
					<DropdownMenu.Group>
						{items.map(item => (
							<DropdownMenu.Item
								...
								{...item.props}
								className={clsx(
									"font-secondary tracking-wide text-gray-800 cursor-pointer hover:bg-purple-100 hover:outline-none px-4 py-2 overflow-hidden",
									// @ts-ignore
